...
- [x] **PUB-01**: Maintainer can create and push a public GitHub repository for `ya-logseq-mcp` with complete repository metadata.
- [x] **PUB-02**: User can discover setup, usage, and troubleshooting information directly from the GitHub repository home.
